const includes = require('@cmg-rv/core-js-alt/includes');
...
describe('longform ads using requireExactDuration field', function() {
  ...
  it('process the bids successfully', function() {
    browser.url(protocol + '://' + host + ':9999/integrationExamples/longform/basic_w_requireExactDuration.html?pbjs_debug=true');
    browser.pause(7000);
